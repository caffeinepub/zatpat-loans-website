...
export class Backend implements backendInterface {
    ...
    async getAllLoanInquiries(): Promise<Array<LoanInquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllLoanInquiries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLoanInquiry(arg0: bigint): Promise<LoanInquiry> {
        if (this.processError) {
            try {
                const result = await this.actor.getLoanInquiry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitLoanInquiry(arg0: string, arg1: string, arg2: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitLoanInquiry(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
